...
## Switches
set_property PACKAGE_PIN V17 [get_ports in_a[0]]					
	set_property IOSTANDARD LVCMOS33 [get_ports in_a[0]]
set_property PACKAGE_PIN V16 [get_ports in_a[1]]					
	set_property IOSTANDARD LVCMOS33 [get_ports in_a[1]
set_property PACKAGE_PIN W16 [get_ports in_a[2]]					
	set_property IOSTANDARD LVCMOS33 [get_ports in_a[2]]
set_property PACKAGE_PIN W17 [get_ports in_a[3]]					
	set_property IOSTANDARD LVCMOS33 [get_ports in_a[3]]
set_property PACKAGE_PIN W15 [get_ports in_b[0]]					
	set_property IOSTANDARD LVCMOS33 [get_ports in_b[0]]
set_property PACKAGE_PIN V15 [get_ports in_b[1]]					
	set_property IOSTANDARD LVCMOS33 [get_ports in_b[1]]
set_property PACKAGE_PIN W14 [get_ports in_b[2]]					
	set_property IOSTANDARD LVCMOS33 [get_ports in_b[2]]
set_property PACKAGE_PIN W13 [get_ports in_b[3]]					
...
set_property PACKAGE_PIN E19 [get_ports {op[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {op[1]}]
set_property PACKAGE_PIN U19 [get_ports {op[2]}]					
